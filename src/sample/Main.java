...
public class Main extends Application {
    ...
    public void start(Stage stage) {
        ...
        //set minimum and maximum width of the components
    ...
    /**
     * Methods to request number of hostel rooms from the user
     *
     * @param
    ...
    public void displayHandler() {
        int i;
        if (list.isEmpty()) //no of rooms to display
        {
